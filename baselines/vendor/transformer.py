# vendored from FS-GNNTR_repo/FS-GNNTR/transformer.py
# Original source: https://github.com/Jz1997/FS-GNNTR
# Only change: `from gnn_models import GNN` → `from vendor.gnn_models import GNN`
# (so this file can be imported without FS-GNNTR_repo in sys.path)

import torch
from torch import nn
from torch_geometric.nn import global_mean_pool
from vendor.gnn_models import GNN
...
class TR(nn.Module):
    ...
    def forward(self, emb):
        *_, h, w, dtype = *emb.shape, emb.dtype
        ...
        pe = position_emb(h)
        h = rearrange(h, 'b h w d -> b (h w) d') + pe
