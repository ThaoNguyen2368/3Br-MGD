...
# ── Repository path ─────────────────────────────────────────────────────────────
# Adjust if FS-GNNTR_repo is located elsewhere relative to project root
...
# ── Pre-trained weights ─────────────────────────────────────────────────────────
# Available in FS-GNNTR_repo/FS-GNNTR/pre-trained/
PRETRAINED_GIN  = os.path.join(FSGNNTR_REPO, 'pre-trained', 'supervised_contextpred.pth')
PRETRAINED_GCN  = os.path.join(FSGNNTR_REPO, 'pre-trained', 'gcn_supervised_contextpred.pth')
PRETRAINED_SAGE = os.path.join(FSGNNTR_REPO, 'pre-trained', 'graphsage_supervised_contextpred.pth')
PRETRAINED_GAT  = os.path.join(FSGNNTR_REPO, 'pre-trained', 'gat_supervised_contextpred.pth')
